<?php
	 ...
	 * @property string $CommentText the value for strCommentText 
	...
	class CommentGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database column Comment.CommentText
		 * @var string strCommentText
		 */
		protected $strCommentText;
		const CommentTextMaxLength = 20;
		const CommentTextDefault = null;


		/**
		 * Protected member variable that maps to the database column Comment.DateCreated
		...
		/**
		 * Protected member variable that maps to the database column Comment.LastUpdated
		...
		/**
		 * Protected member variable that maps to the database column Comment.Account
		...
		/**
		 * Protected member variable that maps to the database column Comment.SearchMetaInfo
		...
		/**
		 * Protected member variable that maps to the database column Comment.Post
		 * @var integer intPost
		 */
		protected $intPost;
		 ...
		 * in the database column Comment.Account.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column Comment.Post.
		 *
		...
		public function Initialize()
		{
			...
			$this->strCommentText = Comment::CommentTextDefault;
			$this->dttDateCreated = (Comment::DateCreatedDefault === null)?null:new QDateTime(Comment::DateCreatedDefault);
			$this->strLastUpdated = Comment::LastUpdatedDefault;
			$this->intAccount = Comment::AccountDefault;
			$this->strSearchMetaInfo = Comment::SearchMetaInfoDefault;
			$this->intPost = Comment::PostDefault;
		}
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'Comment', $intId);
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = Comment::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
		...
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return Comment::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = Comment::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		public static function GetSelectFields(QQueryBuilder $objBuilder, $strPrefix = null, QQSelect $objSelect = null) {
            ...
            if ($objSelect) {
			    ...
			    $objBuilder->AddSelectItem($strTableName, 'Id', $strAliasPrefix . 'Id');
			    $objBuilder->AddSelectItem($strTableName, 'CommentText', $strAliasPrefix . 'CommentText');
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a Comment, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (Comment::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
			...
			$strAlias = $strAliasPrefix . 'CommentText';
			$strAliasName = !empty($strColumnAliasArray[$strAlias]) ? $strColumnAliasArray[$strAlias] : $strAlias;
			$objToReturn->strCommentText = $objDbRow->GetColumn($strAliasName, 'VarChar');
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = Comment::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
		...
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return Comment::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		*/
		public static function LoadArrayByAccount($intAccount, $objOptionalClauses = null) {
			// Call Comment::QueryArray to perform the LoadArrayByAccount query
			try {
				return Comment::QueryArray(
					QQ::Equal(QQN::Comment()->Account, $intAccount),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByAccount($intAccount) {
			// Call Comment::QueryCount to perform the CountByAccount query
		...
		*/
		public static function LoadArrayByPost($intPost, $objOptionalClauses = null) {
			// Call Comment::QueryArray to perform the LoadArrayByPost query
			try {
				return Comment::QueryArray(
					QQ::Equal(QQN::Comment()->Post, $intPost),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByPost($intPost) {
			// Call Comment::QueryCount to perform the CountByPost query
			return Comment::QueryCount(
				QQ::Equal(QQN::Comment()->Post, $intPost)
			);
		}
...
*/
        public function Save($blnForceInsert = false, $blnForceUpdate = false) {
            ...
            if (!$ExistingObj) {
                ...
                $ExistingValueStr = "NULL";
                if (!is_null($ExistingObj->CommentText)) {
                    $ExistingValueStr = $ExistingObj->CommentText;
                }
                if ($ExistingObj->CommentText != $this->strCommentText) {
                    $ChangedArray = array_merge($ChangedArray,array("CommentText" => array("Before" => $ExistingValueStr,"After" => $this->strCommentText)));
                    //$ChangedArray = array_merge($ChangedArray,array("CommentText" => "From: ".$ExistingValueStr." to: ".$this->strCommentText));
                }
                $ExistingValueStr = "NULL";
            ...
            try {
                if ((!$this->__blnRestored) || ($blnForceInsert)) {
                    ...
                    if (!$blnForceUpdate) {
                        ...
                        SELECT `LastUpdated` FROM `Comment` WHERE
							`Id` = ' . $objDatabase->SqlVariable($this->intId) . '');

                    $objRow = $objResult->FetchArray();
                    if ($objRow[0] != $this->strLastUpdated)
                        throw new QOptimisticLockingException('Comment');
                }
				
                // Perform the UPDATE query
                $objDatabase->NonQuery('
                UPDATE `Comment` SET
							`CommentText` = ' . $objDatabase->SqlVariable($this->strCommentText) . ',
            ...
            try {
                ...
                error_log('Could not save audit log while saving Comment. Details: '.$newAuditLogEntry->getJson().'<br>Error details: '.$e->getMessage());
            }
		...
		public function Delete() {
            ...
            try {
                ...
                error_log('Could not save audit log while deleting Comment. Details: '.$newAuditLogEntry->getJson().'<br>Error details: '.$e->getMessage());
            }
		...
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'Comment', $this->intId);
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'CommentText':
					/**
					 * Gets the value for strCommentText 
					 * @return string
					 */
		...
		public function __set($strName, $mixValue) {
			switch ($strName) {
				...
				case 'CommentText':
					/**
					 * Sets the value for strCommentText 
				...
				case 'AccountObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved AccountObject for this Comment');
				...
				case 'PostObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved PostObject for this Comment');
	...
	class QQNodeComment extends QQNode {
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'CommentText':
					return new QQNode('CommentText', 'CommentText', 'VarChar', $this);
				case 'DateCreated':
		...
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
					return new QQNode('Id', 'Id', 'integer', $this);
				case 'CommentText':
					return new QQNode('CommentText', 'CommentText', 'string', $this);
				case 'DateCreated':
