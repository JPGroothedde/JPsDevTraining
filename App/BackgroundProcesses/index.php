...
class BackgroundProcessesForm extends QForm {
	// Data grid variables
	...
	protected function InitBackgroundProcessDataGrid() {
		...
		//TODO: Can change this for multimodular apps to user getCurrentIndividualAttr...
		$Conditions = QQ::None();
		if (is_numeric(AppSpecificFunctions::getCurrentAccountAttribute())) {
			$Conditions = QQ::Equal(QQN::BackgroundProcess()->UserId,AppSpecificFunctions::getCurrentAccountAttribute());
		}
		$this->BackgroundProcessGrid = new BackgroundProcessDataGrid($this, QQN::BackgroundProcess(),$searchableAttributes, 'Search...', $headerItems, $headerSortNodes, $columnItems,
			$Conditions, 10, $this->BackgroundProcessWaitControlIcon, 'BackgroundProcessGrid');
...
BackgroundProcessesForm::Run('BackgroundProcessesForm');
?>