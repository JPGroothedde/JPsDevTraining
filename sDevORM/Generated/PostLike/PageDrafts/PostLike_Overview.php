...
class PostLike_OverviewForm extends QForm {
    ...
    protected function InitPostLikeDataGrid() {
        ...
        $headerItems = array('Additional Search Info','Account Object','Post Object');
        $headerSortNodes = array(QQN::PostLike()->AdditionalSearchInfo,QQN::PostLike()->AccountObject->Id,QQN::PostLike()->PostObject->Id);
