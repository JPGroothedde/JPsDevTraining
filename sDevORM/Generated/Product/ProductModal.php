<?php
?>
<div id="ProductModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ProductModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php require(__SDEV_ORM__.'/Generated/Product/ProductFrontEnd.php');?>
            </div>
