<?php
	 ...
	 */
	class BackgroundProcessGen extends QBaseClass implements IteratorAggregate {
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'BackgroundProcess', $intId);
			...
			$objToReturn = BackgroundProcess::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::BackgroundProcess()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			try {
				return BackgroundProcess::QueryArray(QQ::All(), $objOptionalClauses);
		...
		public static function CountAll() {
			...
			return BackgroundProcess::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'BackgroundProcess');
			...
			if ($blnAddAllFieldsToSelect) {
				BackgroundProcess::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
		...
		/**
		 * Static Qcubed Query method to query for a single BackgroundProcess object.
		...
		/**
		 * Static Qcubed Query method to query for an array of BackgroundProcess objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		/**
		 * Static Qcubed Query method to query for a count of BackgroundProcess objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/backgroundprocess', $strQuery);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this BackgroundProcess
    ...
    $newAuditLogEntry->AuditLogEntryDetail = '<strong>Values after create:</strong> <br>';
		...
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this BackgroundProcess with an unset primary key.');
		...
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'BackgroundProcess', $this->intId);
		...
		public function Reload() {
			...
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved BackgroundProcess object.');
		...
		public function __set($strName, $mixValue) {
			switch ($strName) {
				...
				case 'PId':
					 ...
					 */
					try {
						return ($this->strPId = QType::Cast($mixValue, QType::String));
					} catch (QCallerException $objExc) {
						$objExc->IncrementOffset();
						throw $objExc;
					}
				...
				case 'StartDateTime':
					 ...
					 */
					try {
						return ($this->dttStartDateTime = QType::Cast($mixValue, QType::DateTime));
					} catch (QCallerException $objExc) {
						$objExc->IncrementOffset();
						throw $objExc;
					}
		...
		*/
		public function AssociateBackgroundProcessUpdate(BackgroundProcessUpdate $objBackgroundProcessUpdate) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateBackgroundProcessUpdate on this unsaved BackgroundProcess.');
			if ((is_null($objBackgroundProcessUpdate->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateBackgroundProcessUpdate on this BackgroundProcess with an unsaved BackgroundProcessUpdate.');
		...
		*/
		public function UnassociateBackgroundProcessUpdate(BackgroundProcessUpdate $objBackgroundProcessUpdate) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateBackgroundProcessUpdate on this unsaved BackgroundProcess.');
			if ((is_null($objBackgroundProcessUpdate->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateBackgroundProcessUpdate on this BackgroundProcess with an unsaved BackgroundProcessUpdate.');
		...
		*/
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[BackgroundProcess::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapObjectFromObject($objObject, $blnBindRelatedObjects) {
			...
			if ($objObject->dttStartDateTime)
				$objObject->dttStartDateTime = $objObject->dttStartDateTime->qFormat(QDateTime::FormatSoap);
			return $objObject;
		}
     ...
     **/
	class QQNodeBackgroundProcess extends QQNode {
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'PId':
					return new QQNode('PId', 'PId', 'VarChar', $this);
				case 'UserId':
					return new QQNode('UserId', 'UserId', 'VarChar', $this);
				case 'UpdateDateTime':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeBackgroundProcess extends QQReverseReferenceNode {
		protected $strTableName = 'BackgroundProcess';
		protected $strPrimaryKey = 'Id';
		protected $strClassName = 'BackgroundProcess';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
					return new QQNode('Id', 'Id', 'integer', $this);
				case 'PId':
					return new QQNode('PId', 'PId', 'string', $this);
				case 'UserId':
					return new QQNode('UserId', 'UserId', 'string', $this);
				case 'UpdateDateTime':
