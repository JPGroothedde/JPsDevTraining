<?php
	if (!defined('__PREPEND_INCLUDED__')) {
		...
		if (file_exists(dirname(__FILE__) . '/configuration.inc.php')) {
            ...
            define ('__SDEV_ORM__',__DOCROOT__.'/sDevORM');
		...
		//////////////////////////////
		// Include the QCubed Framework which handles the base ORM classes for the sDev Framework
		//////////////////////////////
		require(__QCUBED_CORE__ . '/framework/DisableMagicQuotes.inc.php');
		require_once(__QCUBED_CORE__ . '/qcubed.inc.php');
