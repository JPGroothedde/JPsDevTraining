<?php
	 ...
	 * @property-read Comment $_Comment the value for the private _objComment (Read-Only) if set due to an expansion on the Comment.Account reverse relationship
	 * @property-read Comment[] $_CommentArray the value for the private _objCommentArray (Read-Only) if set due to an ExpandAsArray on the Comment.Account reverse relationship
	...
	class AccountGen extends QBaseClass implements IteratorAggregate {
		 ...
		 * (of type Comment), if this Account object was restored with
...
*/
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case '_Comment':
					 ...
					 * if set due to an expansion on the Comment.Account reverse relationship
					 * @return Comment
					 */
				...
				case '_CommentArray':
					 ...
					 * if set due to an ExpandAsArray on the Comment.Account reverse relationship
					 * @return Comment[]
					 */
		...
		*/
		public function GetCommentArray($objOptionalClauses = null) {
			...
			try {
				return Comment::LoadArrayByAccount($this->intId, $objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		*/
		public function CountComments() {
			...
			return Comment::CountByAccount($this->intId);
		}
		...
		*/
		public function AssociateComment(Comment $objComment) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateComment on this unsaved Account.');
			if ((is_null($objComment->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateComment on this Account with an unsaved Comment.');
		...
		*/
		public function UnassociateComment(Comment $objComment) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateComment on this unsaved Account.');
			if ((is_null($objComment->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateComment on this Account with an unsaved Comment.');
	...
	class QQNodeAccount extends QQNode {
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'Comment':
					return new QQReverseReferenceNodeComment($this, 'comment', 'reverse_reference', 'Account', 'Comment');
				case 'LoginToken':
