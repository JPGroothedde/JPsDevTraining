...
class PostLike_ListForm extends QForm {
    ...
    protected function InitPostLikeDataList() {
        $searchableAttributes = array(QQN::PostLike()->AdditionalSearchInfo,QQN::PostLike()->AccountObject->Id,QQN::PostLike()->PostObject->Id);
        $SortAttributesShown = array('Additional Search Info','Account Object','Post Object');
        $SortAttributes = array(QQN::PostLike()->AdditionalSearchInfo,QQN::PostLike()->AccountObject->Id,QQN::PostLike()->PostObject->Id);
        $columnItems = array('AdditionalSearchInfo','Account','Post');
