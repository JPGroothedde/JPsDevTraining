<?php
	class QQN {
		...
		/**
		 * @return QQNodeEducation
		 */
		static public function Education() {
			return new QQNodeEducation('Education', null, null);
		}
		/**
		...
		/**
		 * @return QQNodeEmploymentHistory
		 */
		static public function EmploymentHistory() {
			return new QQNodeEmploymentHistory('EmploymentHistory', null, null);
		}
		/**
		...
		/**
		 * @return QQNodeMasterLanguage
		 */
		static public function MasterLanguage() {
		...
		static public function Reference() {
			return new QQNodeReference('Reference', null, null);
		}
		/**
