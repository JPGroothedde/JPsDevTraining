	...
	class UserRoleGen extends QBaseClass implements IteratorAggregate {
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'UserRole', $intId);
			...
			$objToReturn = UserRole::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::UserRole()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			try {
				return UserRole::QueryArray(QQ::All(), $objOptionalClauses);
		...
		public static function CountAll() {
			...
			return UserRole::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'UserRole');
			...
			if ($blnAddAllFieldsToSelect) {
				UserRole::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
		...
		/**
		 * Static Qcubed Query method to query for a single UserRole object.
		...
		/**
		 * Static Qcubed Query method to query for an array of UserRole objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		/**
		 * Static Qcubed Query method to query for a count of UserRole objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/userrole', $strQuery);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this UserRole
		...
		*/
		public static function LoadByRole($strRole, $objOptionalClauses = null) {
			return UserRole::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::UserRole()->Role, $strRole)
				),
				$objOptionalClauses
			);
		}
...
*/
		...
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this UserRole with an unset primary key.');
		...
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'UserRole', $this->intId);
		...
		public function Reload() {
			...
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved UserRole object.');
		...
		*/
		public function AssociateAccount(Account $objAccount) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateAccount on this unsaved UserRole.');
			if ((is_null($objAccount->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call AssociateAccount on this UserRole with an unsaved Account.');
		...
		*/
		public function UnassociateAccount(Account $objAccount) {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateAccount on this unsaved UserRole.');
			if ((is_null($objAccount->Id)))
				throw new QUndefinedPrimaryKeyException('Unable to call UnassociateAccount on this UserRole with an unsaved Account.');
		...
		*/
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[UserRole::GetDatabaseIndex()]->Database;
		}
     ...
     **/
	class QQNodeUserRole extends QQNode {
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeUserRole extends QQReverseReferenceNode {
		protected $strTableName = 'UserRole';
		protected $strPrimaryKey = 'Id';
		protected $strClassName = 'UserRole';
		public function __get($strName) {
