<?php
	require(__MODEL_GEN__ . '/UserRoleGen.class.php');
...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of UserRole objects
			return UserRole::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::UserRole()->Param1, $strParam1),
					QQ::GreaterThan(QQN::UserRole()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single UserRole object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of UserRole objects
			return UserRole::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::UserRole()->Param1, $strParam1),
					QQ::Equal(QQN::UserRole()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses) {
			...
			return UserRole::InstantiateDbResult($objDbResult);
		}
*/
