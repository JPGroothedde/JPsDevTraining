<?php
	require(__MODEL_GEN__ . '/ApiKeyGen.class.php');
...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of ApiKey objects
			return ApiKey::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::ApiKey()->Param1, $strParam1),
					QQ::GreaterThan(QQN::ApiKey()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single ApiKey object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of ApiKey objects
			return ApiKey::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::ApiKey()->Param1, $strParam1),
					QQ::Equal(QQN::ApiKey()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses) {
			...
			return ApiKey::InstantiateDbResult($objDbResult);
		}
*/
