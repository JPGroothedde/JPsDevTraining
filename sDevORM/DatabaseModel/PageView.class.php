<?php
	require(__MODEL_GEN__ . '/PageViewGen.class.php');
...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of PageView objects
			return PageView::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::PageView()->Param1, $strParam1),
					QQ::GreaterThan(QQN::PageView()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single PageView object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of PageView objects
			return PageView::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::PageView()->Param1, $strParam1),
					QQ::Equal(QQN::PageView()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses) {
			...
			return PageView::InstantiateDbResult($objDbResult);
		}
*/
