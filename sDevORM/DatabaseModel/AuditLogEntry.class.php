<?php
	require(__MODEL_GEN__ . '/AuditLogEntryGen.class.php');
...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of AuditLogEntry objects
			return AuditLogEntry::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::AuditLogEntry()->Param1, $strParam1),
					QQ::GreaterThan(QQN::AuditLogEntry()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single AuditLogEntry object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of AuditLogEntry objects
			return AuditLogEntry::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::AuditLogEntry()->Param1, $strParam1),
					QQ::Equal(QQN::AuditLogEntry()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses) {
			...
			return AuditLogEntry::InstantiateDbResult($objDbResult);
		}
*/
