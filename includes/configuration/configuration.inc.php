 ...
 */
require_once('ConfigurationComponents/sdev_version_config.inc.php');
require_once('ConfigurationComponents/app_config.inc.php');
require_once('ConfigurationComponents/sdev_config.inc.php');
?>
