<?php
	require(__MODEL_GEN__ . '/FileDocumentGen.class.php');
...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of FileDocument objects
			return FileDocument::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::FileDocument()->Param1, $strParam1),
					QQ::GreaterThan(QQN::FileDocument()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single FileDocument object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of FileDocument objects
			return FileDocument::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::FileDocument()->Param1, $strParam1),
					QQ::Equal(QQN::FileDocument()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses) {
			...
			return FileDocument::InstantiateDbResult($objDbResult);
		}
*/
