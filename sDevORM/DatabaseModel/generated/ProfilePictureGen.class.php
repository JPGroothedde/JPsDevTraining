<?php
	/**
	 * The abstract ProfilePictureGen class defined here is
	 * code-generated and contains all the basic CRUD-type functionality as well as
	 * basic methods to handle relationships and index-based loading.
	 *
	 * To use, you should use the ProfilePicture subclass which
	 * extends this ProfilePictureGen class.
	 *
	 * Because subsequent re-code generations will overwrite any changes to this
	 * file, you should leave this file unaltered to prevent yourself from losing
	 * any information or code changes.  All customizations should be done by
	 * overriding existing or implementing new methods, properties and variables
	 * in the ProfilePicture class.
	 *
	 ...
	 */
	class ProfilePictureGen extends QBaseClass implements IteratorAggregate {
		...
		/**
		 * Protected member variable that maps to the database PK Identity column ProfilePicture.Id
		 * @var integer intId
		 */
		protected $intId;
		...
		/**
		 * Protected member variable that maps to the database column ProfilePicture.ProfilePicturePath
		 * @var string strProfilePicturePath
		 */
		protected $strProfilePicturePath;
		const ProfilePicturePathMaxLength = 100;
		const ProfilePicturePathDefault = null;


		/**
		 * Protected member variable that maps to the database column ProfilePicture.LastUpdated
		...
		/**
		 * Protected member variable that maps to the database column ProfilePicture.Account
		...
		/**
		 * Protected member variable that maps to the database column ProfilePicture.SearchMetaInfo
		...
		/**
		 * Protected member variable that maps to the database column ProfilePicture.FileDocument
		 ...
		 * in the database column ProfilePicture.Account.
		 *
		...
		/**
		 * Protected member variable that contains the object pointed by the reference
		 * in the database column ProfilePicture.FileDocument.
		 *
		...
		{
			$this->intId = ProfilePicture::IdDefault;
			$this->strProfilePicturePath = ProfilePicture::ProfilePicturePathDefault;
			$this->strLastUpdated = ProfilePicture::LastUpdatedDefault;
			$this->intAccount = ProfilePicture::AccountDefault;
			$this->strSearchMetaInfo = ProfilePicture::SearchMetaInfoDefault;
			$this->intFileDocument = ProfilePicture::FileDocumentDefault;
		}
		...
		/**
		 * Load a ProfilePicture from PK Info
		 * @param integer $intId
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'ProfilePicture', $intId);
			...
			$objToReturn = ProfilePicture::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::ProfilePicture()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			// Call ProfilePicture::QueryArray to perform the LoadAll query
			try {
				return ProfilePicture::QueryArray(QQ::All(), $objOptionalClauses);
		...
		/**
		 * Count all ProfilePictures
		 * @return int
		 */
		public static function CountAll() {
			// Call ProfilePicture::QueryCount to perform the CountAll query
			return ProfilePicture::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objDatabase = ProfilePicture::GetDatabase();

			// Create/Build out the QueryBuilder object with ProfilePicture-specific SELET and FROM fields
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'ProfilePicture');
			...
			if ($blnAddAllFieldsToSelect) {
				ProfilePicture::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
			$objQueryBuilder->AddFromItem('ProfilePicture');
		...
		/**
		 * Static Qcubed Query method to query for a single ProfilePicture object.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return ProfilePicture the queried object
		 */
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = ProfilePicture::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, false);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}

			// Perform the Query, Get the First Row, and Instantiate a new ProfilePicture object
			...
			if ($objQueryBuilder->ExpandAsArrayNode) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = ProfilePicture::InstantiateDbRow($objDbRow, null, $objQueryBuilder->ExpandAsArrayNode, $objPrevItemArray, $objQueryBuilder->ColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
				...
				if(null === $objDbRow)
					return null;
				return ProfilePicture::InstantiateDbRow($objDbRow, null, null, null, $objQueryBuilder->ColumnAliasArray);
			}
		}

		/**
		 * Static Qcubed Query method to query for an array of ProfilePicture objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		 * @return ProfilePicture[] the queried objects as an array
		 */
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return ProfilePicture::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		}
		...
		/**
		 * Static Qcubed Query method to query for a count of ProfilePicture objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryCount(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			// Get the Query Statement
			try {
				$strQuery = ProfilePicture::BuildQueryStatement($objQueryBuilder, $objConditions, $objOptionalClauses, $mixParameterArray, true);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
			}
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/profilepicture', $strQuery);
			$cacheData = $objCache->GetData();

			if (!$cacheData || $blnForceUpdate) {
				$objDbResult = $objQueryBuilder->Database->Query($strQuery);
				$arrResult = ProfilePicture::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNode, $objQueryBuilder->ColumnAliasArray);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this ProfilePicture
		...
		/**
		 * Instantiate a ProfilePicture from a Database Row.
		 * Takes in an optional strAliasPrefix, used in case another Object::InstantiateDbRow
		 * is calling this ProfilePicture::InstantiateDbRow in order to perform
		 ...
		 * @param string[] $strColumnAliasArray
		 * @return mixed Either a ProfilePicture, or false to indicate the dbrow was used in an expansion, or null to indicate that this leaf is a duplicate.
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $objExpandAsArrayNode = null, $objPreviousItemArray = null, $strColumnAliasArray = array()) {
			...
			if ($objExpandAsArrayNode && 
				...
				if (ProfilePicture::ExpandArray ($objDbRow, $strAliasPrefix, $objExpandAsArrayNode, $objPreviousItemArray, $strColumnAliasArray)) {
					return false; // db row was used but no new object was created
				}
			}

			// Create a new instance of the ProfilePicture object
			$objToReturn = new ProfilePicture();
			...
			if (!$strAliasPrefix)
				$strAliasPrefix = 'ProfilePicture__';
		...
		/**
		 * Instantiate an array of ProfilePictures from a Database Result
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $objExpandAsArrayNode = null, $strColumnAliasArray = null) {
			...
			if ($objExpandAsArrayNode) {
				...
				$objPrevItemArray = array();
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = ProfilePicture::InstantiateDbRow($objDbRow, null, $objExpandAsArrayNode, $objPrevItemArray, $strColumnAliasArray);
					if ($objItem) {
						$objToReturn[] = $objItem;
						$objPrevItemArray[$objItem->intId][] = $objItem;
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					$objToReturn[] = ProfilePicture::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
			}
		...
		/**
		 * Instantiate a single ProfilePicture object from a query cursor (e.g. a DB ResultSet).
		 * Cursor is automatically moved to the "next row" of the result set.
		 * Will return NULL if no cursor or if the cursor has no more rows in the resultset.
		 * @param QDatabaseResultBase $objDbResult cursor resource
		 * @return ProfilePicture next row resulting from the query
		 */
		public static function InstantiateCursor(QDatabaseResultBase $objDbResult) {
			...
			return ProfilePicture::InstantiateDbRow($objDbRow, null, null, null, $strColumnAliasArray);
		}
		...
		/**
		 * Load a single ProfilePicture object,
		 * by Id Index(es)
		 * @param integer $intId
		 * @param QQClause[] $objOptionalClauses additional optional QQClause objects for this query
		 * @return ProfilePicture
		*/
		public static function LoadById($intId, $objOptionalClauses = null) {
			return ProfilePicture::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::ProfilePicture()->Id, $intId)
				),
				$objOptionalClauses
		...
		/**
		 * Load an array of ProfilePicture objects,
		 * by Account Index(es)
		...
		*/
		public static function LoadArrayByAccount($intAccount, $objOptionalClauses = null) {
			// Call ProfilePicture::QueryArray to perform the LoadArrayByAccount query
			try {
				return ProfilePicture::QueryArray(
					QQ::Equal(QQN::ProfilePicture()->Account, $intAccount),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		/**
		 * Count ProfilePictures
		 * by Account Index(es)
		 * @param integer $intAccount
		 * @return int
		*/
		public static function CountByAccount($intAccount) {
			// Call ProfilePicture::QueryCount to perform the CountByAccount query
			return ProfilePicture::QueryCount(
				QQ::Equal(QQN::ProfilePicture()->Account, $intAccount)
			);
		}
		...
		*/
		public static function LoadArrayByFileDocument($intFileDocument, $objOptionalClauses = null) {
			// Call ProfilePicture::QueryArray to perform the LoadArrayByFileDocument query
			try {
				return ProfilePicture::QueryArray(
					QQ::Equal(QQN::ProfilePicture()->FileDocument, $intFileDocument),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
		...
		*/
		public static function CountByFileDocument($intFileDocument) {
			// Call ProfilePicture::QueryCount to perform the CountByFileDocument query
			return ProfilePicture::QueryCount(
				QQ::Equal(QQN::ProfilePicture()->FileDocument, $intFileDocument)
			);
		}
...
*/
        public function Save($blnForceInsert = false, $blnForceUpdate = false) {
            ...
            $objDatabase = ProfilePicture::GetDatabase();
            $mixToReturn = null;
            $ExistingObj = ProfilePicture::Load($this->intId);
            $newAuditLogEntry = new AuditLogEntry();
            $ChangedArray = array();
            $newAuditLogEntry->EntryTimeStamp = QDateTime::Now();
            $newAuditLogEntry->ObjectId = $this->intId;
            $newAuditLogEntry->ObjectName = 'ProfilePicture';
            ...
            try {
                if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					$mixToReturn = $this->intId = $objDatabase->InsertId('ProfilePicture', 'Id');                
                } else {
                    ...
                    if (!$blnForceUpdate) {
                        ...
                        SELECT `LastUpdated` FROM `ProfilePicture` WHERE
							`Id` = ' . $objDatabase->SqlVariable($this->intId) . '');

                    $objRow = $objResult->FetchArray();
                    if ($objRow[0] != $this->strLastUpdated)
                        throw new QOptimisticLockingException('ProfilePicture');
                }
				
                // Perform the UPDATE query
                $objDatabase->NonQuery('
                UPDATE `ProfilePicture` SET
            ...
            try {
                ...
                error_log('Could not save audit log while saving ProfilePicture. Details: '.$newAuditLogEntry->getJson().'<br>Error details: '.$e->getMessage());
            }
		...
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this ProfilePicture with an unset primary key.');
            ...
            try {
                ...
                error_log('Could not save audit log while deleting ProfilePicture. Details: '.$newAuditLogEntry->getJson().'<br>Error details: '.$e->getMessage());
            }
        ...
        /**
 	     * Delete this ProfilePicture ONLY from the cache
 		 * @return void
		 */
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'ProfilePicture', $this->intId);
				QApplication::$objCacheProvider->Delete($strCacheKey);
			}
		}

		/**
		 * Delete all ProfilePictures
		 * @return void
		 */
		...
		/**
		 * Reload this ProfilePicture from the database.
		 * @return void
		 */
		public function Reload() {
			// Make sure we are actually Restored from the database
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved ProfilePicture object.');

			$this->DeleteCache();

			// Reload the Object
			$objReloaded = ProfilePicture::Load($this->intId);
		...
		public function __set($strName, $mixValue) {
			switch ($strName) {
				...
				case 'ProfilePicturePath':
					 ...
					 */
					try {
						return ($this->strProfilePicturePath = QType::Cast($mixValue, QType::String));
					} catch (QCallerException $objExc) {
						$objExc->IncrementOffset();
						throw $objExc;
					}
				...
				case 'AccountObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved AccountObject for this ProfilePicture');
				...
				case 'FileDocumentObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved FileDocumentObject for this ProfilePicture');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[ProfilePicture::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetSoapComplexTypeXml() {
			$strToReturn = '<complexType name="ProfilePicture"><sequence>';
		...
		public static function AlterSoapComplexTypeArray(&$strComplexTypeArray) {
			if (!array_key_exists('ProfilePicture', $strComplexTypeArray)) {
				$strComplexTypeArray['ProfilePicture'] = ProfilePicture::GetSoapComplexTypeXml();
		...
		public static function GetArrayFromSoapArray($objSoapArray) {
			...
			foreach ($objSoapArray as $objSoapObject)
				array_push($objArrayToReturn, ProfilePicture::GetObjectFromSoapObject($objSoapObject));
		...
		public static function GetSoapArrayFromArray($objArray) {
			...
			foreach ($objArray as $objObject)
				array_push($objArrayToReturn, ProfilePicture::GetSoapObjectFromObject($objObject, true));
     ...
     * @property-read QQNode $ProfilePicturePath
     ...
     **/
	class QQNodeProfilePicture extends QQNode {
		protected $strTableName = 'ProfilePicture';
		protected $strPrimaryKey = 'Id';
		protected $strClassName = 'ProfilePicture';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
					return new QQNode('Id', 'Id', 'Integer', $this);
				case 'ProfilePicturePath':
					return new QQNode('ProfilePicturePath', 'ProfilePicturePath', 'VarChar', $this);
				case 'LastUpdated':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeProfilePicture extends QQReverseReferenceNode {
		protected $strTableName = 'ProfilePicture';
		protected $strPrimaryKey = 'Id';
		protected $strClassName = 'ProfilePicture';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
					return new QQNode('Id', 'Id', 'integer', $this);
				case 'ProfilePicturePath':
					return new QQNode('ProfilePicturePath', 'ProfilePicturePath', 'string', $this);
				case 'LastUpdated':
