<?php
	 ...
	 */
	class LoginTokenGen extends QBaseClass implements IteratorAggregate {
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'LoginToken', $intId);
			...
			$objToReturn = LoginToken::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::LoginToken()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			try {
				return LoginToken::QueryArray(QQ::All(), $objOptionalClauses);
		...
		public static function CountAll() {
			...
			return LoginToken::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'LoginToken');
			...
			if ($blnAddAllFieldsToSelect) {
				LoginToken::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
		...
		/**
		 * Static Qcubed Query method to query for a single LoginToken object.
		...
		/**
		 * Static Qcubed Query method to query for an array of LoginToken objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		/**
		 * Static Qcubed Query method to query for a count of LoginToken objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/logintoken', $strQuery);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this LoginToken
		...
		*/
		public static function LoadByLoginToken($strLoginToken, $objOptionalClauses = null) {
			return LoginToken::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::LoginToken()->LoginToken, $strLoginToken)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadArrayByAccount($intAccount, $objOptionalClauses = null) {
			...
			try {
				return LoginToken::QueryArray(
					QQ::Equal(QQN::LoginToken()->Account, $intAccount),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
    ...
    $newAuditLogEntry->AuditLogEntryDetail = '<strong>Values after create:</strong> <br>';
		...
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this LoginToken with an unset primary key.');
		...
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'LoginToken', $this->intId);
		...
		public function Reload() {
			...
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved LoginToken object.');
		...
		public function __set($strName, $mixValue) {
			switch ($strName) {
				...
				case 'LoginToken':
					 ...
					 */
					try {
						return ($this->strLoginToken = QType::Cast($mixValue, QType::String));
					} catch (QCallerException $objExc) {
						$objExc->IncrementOffset();
						throw $objExc;
					}
				...
				case 'AccountObject':
					...
					if (is_null($mixValue)) {
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved AccountObject for this LoginToken');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[LoginToken::GetDatabaseIndex()]->Database;
		}
     ...
     **/
	class QQNodeLoginToken extends QQNode {
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeLoginToken extends QQReverseReferenceNode {
		protected $strTableName = 'LoginToken';
		protected $strPrimaryKey = 'Id';
		protected $strClassName = 'LoginToken';
		public function __get($strName) {
