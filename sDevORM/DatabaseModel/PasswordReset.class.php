<?php
	require(__MODEL_GEN__ . '/PasswordResetGen.class.php');
...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of PasswordReset objects
			return PasswordReset::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::PasswordReset()->Param1, $strParam1),
					QQ::GreaterThan(QQN::PasswordReset()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single PasswordReset object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of PasswordReset objects
			return PasswordReset::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::PasswordReset()->Param1, $strParam1),
					QQ::Equal(QQN::PasswordReset()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses) {
			...
			return PasswordReset::InstantiateDbResult($objDbResult);
		}
*/
