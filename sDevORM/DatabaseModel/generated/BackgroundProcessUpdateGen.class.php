<?php
	 ...
	 */
	class BackgroundProcessUpdateGen extends QBaseClass implements IteratorAggregate {
		 ...
		 * @var QDateTime dttUpdateDateTime
		 */
		...
		public function Initialize()
		{
			...
			$this->dttUpdateDateTime = (BackgroundProcessUpdate::UpdateDateTimeDefault === null)?null:new QDateTime(BackgroundProcessUpdate::UpdateDateTimeDefault);
		...
		public static function Load($intId, $objOptionalClauses = null) {
			...
			if (QApplication::$objCacheProvider && !$objOptionalClauses && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'BackgroundProcessUpdate', $intId);
			...
			$objToReturn = BackgroundProcessUpdate::QuerySingle(
				QQ::AndCondition(
					QQ::Equal(QQN::BackgroundProcessUpdate()->Id, $intId)
				),
				$objOptionalClauses
			);
		...
		public static function LoadAll($objOptionalClauses = null) {
			...
			try {
				return BackgroundProcessUpdate::QueryArray(QQ::All(), $objOptionalClauses);
		...
		public static function CountAll() {
			...
			return BackgroundProcessUpdate::QueryCount(QQ::All());
		}
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objQueryBuilder = new QQueryBuilder($objDatabase, 'BackgroundProcessUpdate');
			...
			if ($blnAddAllFieldsToSelect) {
				BackgroundProcessUpdate::GetSelectFields($objQueryBuilder, null, QQuery::extractSelectClause($objOptionalClauses));
			}
		...
		/**
		 * Static Qcubed Query method to query for a single BackgroundProcessUpdate object.
		...
		/**
		 * Static Qcubed Query method to query for an array of BackgroundProcessUpdate objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		/**
		 * Static Qcubed Query method to query for a count of BackgroundProcessUpdate objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryArrayCached(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null, $blnForceUpdate = false) {
			...
			$objCache = new QCache('qquery/backgroundprocessupdate', $strQuery);
		...
		/**
		 * Updates a QQueryBuilder with the SELECT fields for this BackgroundProcessUpdate
		...
		public static function LoadArrayByBackgroundProcess($intBackgroundProcess, $objOptionalClauses = null) {
			...
			try {
				return BackgroundProcessUpdate::QueryArray(
					QQ::Equal(QQN::BackgroundProcessUpdate()->BackgroundProcess, $intBackgroundProcess),
					$objOptionalClauses);
			} catch (QCallerException $objExc) {
				$objExc->IncrementOffset();
				throw $objExc;
    ...
    $newAuditLogEntry->AuditLogEntryDetail = '<strong>Values after create:</strong> <br>';
                ...
                $newAuditLogEntry->AuditLogEntryDetail .= 'UpdateMessage -> '.$this->strUpdateMessage.'<br>';
                $newAuditLogEntry->AuditLogEntryDetail .= 'LastUpdated -> '.$this->strLastUpdated.'<br>';
                $newAuditLogEntry->AuditLogEntryDetail .= 'BackgroundProcess -> '.$this->intBackgroundProcess.'<br>';
                ...
                if ($ExistingObj->UpdateMessage) {
                    $newAuditLogEntry->AuditLogEntryDetail .= 'UpdateMessage -> '.$ExistingObj->UpdateMessage.'<br>';
                } else {
                    $newAuditLogEntry->AuditLogEntryDetail .= 'UpdateMessage -> NULL<br>';
                }
                ...
                if ($ExistingObj->BackgroundProcess) {
                    $newAuditLogEntry->AuditLogEntryDetail .= 'BackgroundProcess -> '.$ExistingObj->BackgroundProcess.'<br>';
                } else {
                    $newAuditLogEntry->AuditLogEntryDetail .= 'BackgroundProcess -> NULL<br>';
                }
            ...
            try {
                ...
                AppSpecificFunctions::AddCustomLog('Could not save audit log while saving BackgroundProcessUpdate. Details: '.$newAuditLogEntry->getJson().'<br>Error details: '.$e->getMessage());
            }
			try {
				if ((!$this->__blnRestored) || ($blnForceInsert)) {
					...
					if (!$blnForceUpdate) {
						...
						if ($objRow[0] != $this->strLastUpdated)
							throw new QOptimisticLockingException('BackgroundProcessUpdate');
					}
		...
		public function Delete() {
			if ((is_null($this->intId)))
				throw new QUndefinedPrimaryKeyException('Cannot delete this BackgroundProcessUpdate with an unset primary key.');
            ...
            try {
                ...
                AppSpecificFunctions::AddCustomLog('Could not save audit log while deleting BackgroundProcessUpdate. Details: '.$newAuditLogEntry->getJson().'<br>Error details: '.$e->getMessage());
            }
		...
		public function DeleteCache() {
			if (QApplication::$objCacheProvider && QApplication::$Database[1]->Caching) {
				$strCacheKey = QApplication::$objCacheProvider->CreateKey(QApplication::$Database[1]->Database, 'BackgroundProcessUpdate', $this->intId);
		...
		public function Reload() {
			...
			if (!$this->__blnRestored)
				throw new QCallerException('Cannot call Reload() on a new, unsaved BackgroundProcessUpdate object.');
		...
		public function __set($strName, $mixValue) {
			switch ($strName) {
				...
				case 'UpdateDateTime':
					 ...
					 */
					try {
						return ($this->dttUpdateDateTime = QType::Cast($mixValue, QType::DateTime));
					} catch (QCallerException $objExc) {
						$objExc->IncrementOffset();
						throw $objExc;
					}
				...
				case 'UpdateMessage':
					 ...
					 */
					try {
						return ($this->strUpdateMessage = QType::Cast($mixValue, QType::String));
					} catch (QCallerException $objExc) {
						$objExc->IncrementOffset();
						throw $objExc;
					}
				...
				case 'BackgroundProcess':
					...
					try {
						...
						return ($this->intBackgroundProcess = QType::Cast($mixValue, QType::Integer));
					} catch (QCallerException $objExc) {
						$objExc->IncrementOffset();
						throw $objExc;
					}
				...
				case 'BackgroundProcessObject':
					...
					if (is_null($mixValue)) {
						...
						try {
							$mixValue = QType::Cast($mixValue, 'BackgroundProcess');
						...
						if (is_null($mixValue->Id))
							throw new QCallerException('Unable to set an unsaved BackgroundProcessObject for this BackgroundProcessUpdate');
		...
		public static function GetDatabaseName() {
			return QApplication::$Database[BackgroundProcessUpdate::GetDatabaseIndex()]->Database;
		}
		...
		public static function GetObjectFromSoapObject($objSoapObject) {
			...
			if (property_exists($objSoapObject, 'UpdateDateTime'))
				$objToReturn->dttUpdateDateTime = new QDateTime($objSoapObject->UpdateDateTime);
		...
		public static function GetSoapObjectFromObject($objObject, $blnBindRelatedObjects) {
			if ($objObject->dttUpdateDateTime)
				$objObject->dttUpdateDateTime = $objObject->dttUpdateDateTime->qFormat(QDateTime::FormatSoap);
     ...
     * @property-read QQNode $UpdateMessage
     * @property-read QQNode $LastUpdated
     * @property-read QQNode $BackgroundProcess
     * @property-read QQNodeBackgroundProcess $BackgroundProcessObject
     ...
     **/
	class QQNodeBackgroundProcessUpdate extends QQNode {
		...
		public function __get($strName) {
			switch ($strName) {
				...
				case 'UpdateDateTime':
					return new QQNode('UpdateDateTime', 'UpdateDateTime', 'DateTime', $this);
				case 'UpdateMessage':
					return new QQNode('UpdateMessage', 'UpdateMessage', 'Blob', $this);
				case 'LastUpdated':
					return new QQNode('LastUpdated', 'LastUpdated', 'VarChar', $this);
				case 'BackgroundProcess':
					return new QQNode('BackgroundProcess', 'BackgroundProcess', 'Integer', $this);
				case 'BackgroundProcessObject':
					return new QQNodeBackgroundProcess('BackgroundProcess', 'BackgroundProcessObject', 'Integer', $this);
				case 'SearchMetaInfo':
     ...
     * @property-read QQNode $_PrimaryKeyNode
     **/
	class QQReverseReferenceNodeBackgroundProcessUpdate extends QQReverseReferenceNode {
		protected $strTableName = 'BackgroundProcessUpdate';
		protected $strPrimaryKey = 'Id';
		protected $strClassName = 'BackgroundProcessUpdate';
		public function __get($strName) {
			switch ($strName) {
				case 'Id':
					return new QQNode('Id', 'Id', 'integer', $this);
				case 'UpdateDateTime':
					return new QQNode('UpdateDateTime', 'UpdateDateTime', 'QDateTime', $this);
				case 'UpdateMessage':
					return new QQNode('UpdateMessage', 'UpdateMessage', 'string', $this);
				case 'LastUpdated':
