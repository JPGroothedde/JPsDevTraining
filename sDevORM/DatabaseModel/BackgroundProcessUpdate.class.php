<?php
	require(__MODEL_GEN__ . '/BackgroundProcessUpdateGen.class.php');
...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return an array of BackgroundProcessUpdate objects
			return BackgroundProcessUpdate::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::BackgroundProcessUpdate()->Param1, $strParam1),
					QQ::GreaterThan(QQN::BackgroundProcessUpdate()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single BackgroundProcessUpdate object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of BackgroundProcessUpdate objects
			return BackgroundProcessUpdate::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::BackgroundProcessUpdate()->Param1, $strParam1),
					QQ::Equal(QQN::BackgroundProcessUpdate()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses) {
			...
			$strQuery = sprintf('
				...
				FROM
					`BackgroundProcessUpdate` AS `BackgroundProcessUpdate`
				WHERE
					param_1 = %s AND
					param_2 < %s',
				$strParam1, $intParam2);
			...
			return BackgroundProcessUpdate::InstantiateDbResult($objDbResult);
		}
*/
