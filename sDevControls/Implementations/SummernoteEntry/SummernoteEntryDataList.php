<?php
class SummernoteEntryDataList extends sDataList{
    ...
    public function __construct(QForm $objParentObject, $EntityNode, $SearchableAttributes = null, $SearchBoxText = null, $ColumnItems = null, $SortAttributes = null,
        ...
        parent::__construct(QForm $objParentObject, $EntityNode, $SearchableAttributes, $SearchBoxText, $ColumnItems, $SortAttributes,
